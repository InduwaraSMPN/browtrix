...
export const RipplePulseLoader = ({ className }: { className?: string }) => {
  return (
      ...
      <div className="box">
        <div className="logo">
          ...
          >
            ...
            ></path>
            <path
              d="M86.9 61.8682C86.9 64.5353 84.9301 66.6975 82.5 66.6975H73.6595C71.2295 66.6975 69.2595 64.5353 69.2595 4.82927C69.2595 2.16214 71.2295 0 73.6595 0H82.5C84.9301 0 86.9 2.16214 86.9 4.82927V61.8682Z"
            ></path>
            <path
